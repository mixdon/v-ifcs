        ...
        <div class="col-12">
            ...
            <div id="edit-form-section" class="card mb-4 mx-4" style="display: none;">
                <div class="card-header pb-0">
                    <div class="mb-4">
                        <h5 class="mb-0">Edit Data Pelabuhan Bakauheni</h5>
                    </div>
                </div>
            ...
            <div id="data-table-section" class="card mb-4 mx-4">
                <div class="card-header">
                    <h5 class="mb-0">Data Pelabuhan Bakauheni</h5>
                </div>
                <div>
                    <div class="row mx-3">
                        <div class="col-sm-2">
                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="form-group">
                                        ...
                                        <form action="{{ route('pelabuhan.bakauheni.upload') }}" method="POST"
                ...
                <div class="card-body">
                    ...
                    @if(session('etl_bakauheni_sukses'))
                    <div class="m-3 alert alert-success alert-dismissible fade show" role="alert">
                        <span class="alert-text text-white">
                            {{ session('etl_bakauheni_sukses') }}</span>
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close">
                            <i class="fa fa-close" aria-hidden="true"></i>
                        </button>
                    </div>
                    @endif
                    @if(session('etl_bakauheni_gagal'))
                    <div class="m-3 alert alert-danger alert-dismissible fade show" role="alert">
                        <span class="alert-text text-white">
                            {{ session('etl_bakauheni_gagal') }}</span>
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close">
                            <i class="fa fa-close" aria-hidden="true"></i>
                        </button>
                    </div>
                    ...
                    {{-- Menampilkan pesan sukses/gagal dari session untuk upload --}}
                    @if(session('upload_bakauheni_berhasil'))
                    <div class="m-3 alert alert-success alert-dismissible fade show" id="alert-upload-success"
                        role="alert">
                        <span class="alert-text text-white">
                            {{ session('upload_bakauheni_berhasil') }}</span>
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close">
                            <i class="fa fa-close" aria-hidden="true"></i>
                        </button>
                    </div>
                    @endif
                    @if(session('upload_bakauheni_gagal'))
                    <div class="m-3 alert alert-danger alert-dismissible fade show" id="alert-upload-danger" role="alert">
                        <span class="alert-text text-white">
                            {{ session('upload_bakauheni_gagal') }}</span>
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close">
                            <i class="fa fa-close" aria-hidden="true"></i>
                        </button>
                    </div>
                    ...
                    {{-- Notifikasi untuk update sekarang diletakkan di sini agar tidak tersembunyi --}}
                    @if(session('update_bakauheni_success'))
                    <div class="m-3 alert alert-success alert-dismissible fade show" id="alert-update-success"
                        role="alert">
                        <span class="alert-text text-white">{{ session('update_bakauheni_success') }}</span>
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close">
                            <i class="fa fa-close" aria-hidden="true"></i>
                        </button>
                    </div>
                        ...
                        <div class="tab-content" style="overflow-x: auto;">
                            <div id="IFCS" class="tab-pane fade {{ $selectedTab == 'IFCS' ? 'show active' : '' }}" role="tabpanel" aria-labelledby="ifcs-tab">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        @foreach($pelabuhan_bakauheni as $data)
                                        @if($data->jenis === 'ifcs')
                                        <tr
                                            ...
                                            <td class="text-center sticky-action">
                                                <div class="d-flex justify-content-center align-items-center">
                                                    ...
                                                    <form id="form-delete-{{ $data->id }}"
                                                        action="{{ route('pelabuhan.bakauheni.delete', $data->id) }}"
...
<script>
    ...
    function showEditForm(element) {
        ...
        form.action = `/pelabuhan-bakauheni/${data.id}/update`; // Sesuaikan dengan rute updatePost Anda
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.getElementById('tahunDropdown').addEventListener('change', function() {
            ...
            window.location.href = `{{ route('pelabuhan.bakauheni.index') }}?tahun=${selectedYear}&tab=${selectedTab}`;
        });
        ...
        document.getElementById('run-etl-button').addEventListener('click', function() {
            ...
            if (selectedYear) {
                ...
                form.method = 'POST';
                form.action = `/pelabuhan-bakauheni/run-etl/${selectedYear}`;
