...
class kinerjaIFCSController extends Controller
{
    public function index(Request $request)
    {
        ...
        // Hapus pemanggilan simpanDataTotalKinerja di sini.
        // Total data seharusnya sudah dihitung saat data dimodifikasi (update/upload/delete).
    ...
    public function updatePost(Request $request, $id)
    {
        ...
        // Panggil fungsi total setelah data diperbarui.
    ...
    public function uploadcsvKinerja(Request $request)
    {
        ...
        try {
            ...
            foreach ($uniqueUploadedYears as $tahun) {
                // Panggil fungsi total setelah data CSV diunggah.
    ...
    public function delete(Request $request, $id)
    {
        try {
            ...
            if ($record->delete()) {
                // Panggil fungsi total setelah data dihapus.
